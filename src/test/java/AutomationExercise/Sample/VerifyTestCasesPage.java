...
public class VerifyTestCasesPage {
	...
	public static final String expectedTestCasesLabelName = "TEST CASES";
	...
	public void verifyTestCasesPage() {
		...
		loginPage.clickTestCasesButton();
		String actualTestCasesLabelName = loginPage.verifyTestCasesPageisVisible();
		Assert.assertEquals(actualTestCasesLabelName, expectedTestCasesLabelName);
	}
